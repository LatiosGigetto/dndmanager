...
class Ui_Scheda(object):
    ...
    def setupUi(self, Dialog, gestoreGiocatore:Giocatore.Giocatore):
        ...
        Dialog.resize(651, 812)
        Dialog.setMinimumSize(QtCore.QSize(651, 812))
        Dialog.setMaximumSize(QtCore.QSize(651, 812))
        ...
        self.gridLayout.addWidget(self.textSagg, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textInt, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textDestr, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textCar, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textCost, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textForza, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.textNome, 0, 2, 1, 1)
        ...
        self.textTS1 = QtWidgets.QLabel(Dialog)
    ...
    def visualizza(self):
        ...
        self.textForza.setText(personaggio.punteggi["Forza"])
        self.textDestr.setText(personaggio.punteggi["Destrezza"])
        self.textCost.setText(personaggio.punteggi["Costituzione"])
        self.textInt.setText(personaggio.punteggi["Intelligenza"])
        self.textSagg.setText(personaggio.punteggi["Saggezza"])
        self.textCar.setText(personaggio.punteggi["Carisma"])
        self.textClasse.setText(personaggio.classe)
        self.textLivello.setText(personaggio.livello)
        self.textCA.setText(personaggio.armatura)
        self.textPF.setText(personaggio.puntiFerita)
